...
export default function App() {
  ...
  const [showAlarmStopButton, setShowAlarmStopButton] = useState(false);
  const onSoundEnded = ()=> {
    setShowAlarmStopButton(false);
  }
  ...
  const onStopTimerAlarm = function() {
    timerSound.pauseSound();
    setShowAlarmStopButton(false);
  }
  ...
  const timeLeftStyle = timeLeft <= 10 ? `highlight-effect` : "";
